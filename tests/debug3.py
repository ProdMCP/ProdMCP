...
# Monkey patch HTTPBearer to debug
import prodmcp.security.http as http_mod
original_extract = http_mod.HTTPBearer.extract
def debug_extract(self, context):
    print("DEBUG CONTEXT:", context)
    return original_extract(self, context)
http_mod.HTTPBearer.extract = debug_extract
